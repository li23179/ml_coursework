...
parameters = {"max_depth": [5, 10, 15, 20], "criterion": ["gini", "entropy"]}
...
# get the best params and the score 
...
# find the incorrect indices, where returns a 1D array
# extract elements that satisfy this cond
incorrect_indices = np.where(y_pred != y_test)[0]
print(f"Number of misclassified images: {len(incorrect_indices)} out of {X_test_reduced.shape[0]}")

# class label in CIFAR from the website
classes = [
    "airplane",
    "automobile",
    "bird",
...
# define a subplots of 1 row, 5 col
